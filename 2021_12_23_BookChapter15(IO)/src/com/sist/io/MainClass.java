...
*       3. 보조 스트림 : Buffered => 데이터를 메모리에 한번에 모았다가 사용
*                                   => 속도가 빠르다
...
*           7) 폴더에 있는 모든 파일과 폴더를 읽기 => listFiles()
*           8) exists() : 존재여부 확인
*           =======================================================
*           ==> 이후 웹에서 다운로드 / 업로드
*           9) lastModified() => 마지막 수정한 날짜
*           =======================================================
*           1. 저장하는 공간
...
public class MainClass {
    public static void main(String[] args) {
        try {
            ...
            // 1. File에 대한 정보
            // 1-1 파일 가지고 오기
            File file = new File("/Users/kimheejun/IdeaProjects/Ssangyong_new/2021_11_BookChapter8/movie.txt");
            // 본인이 가지고 있는 파일 선택
            // ***1. 파일 이름 읽기
            ...
            // 6. 특성 => 숨김파일, 읽기전용, 쓰기전용
            System.out.println("숨김파일 : "+(file.isHidden()));    //false

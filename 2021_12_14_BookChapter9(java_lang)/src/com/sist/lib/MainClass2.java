...
public class MainClass2 {
	...
	public static void main(String[] args) throws Exception {
		...
		/*
		 * class A { String name; String sex; } class B extends A { ========== String
		 * name; String sex; ========== int age; }
		 * 
		 * A a=new A(); ====> name , sex B b=new B(); ====> name , sex , age A c=new
		 * B(); ====> name,sex (A클래스가 가지고 있는 변수만) === c.age = (X) 클래스 => 제어하는 변수 메소드는
		 * 생성자 타입
		 */

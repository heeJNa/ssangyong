 ...
 * class A { }
 * 
 * => 1. 클래스 저장 ========= A a=new A(); // 리플렉션 Class.forName() => JVM => this=a;
 * => 객체 저장 주소를 기억하고 있다
 * 
 * 2. 상속 (속도가 저하 => JOIN (Subquery) ==> 최적화 메모리 할당 ==> 상속 내리는 클래스 메모리 할당 상속 받는
 * 클래스 메모리 할당
 */
public class MainClass5 {
	...
	public static void main(String[] args) {
		...
		/*
		 * 1. 생성자 호출 new 생성자() 2. 예외처리 호출 throw new 생성자() => 예외 던지기 (예외처리를 찾는다)
		 * 
		 * 
